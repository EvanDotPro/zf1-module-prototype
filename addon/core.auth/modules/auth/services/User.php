...
class Auth_Service_User 
{
    ...
    public function __construct(Auth_Model_Mapper_User $userMapper = null)
    {
        $this->_mapper = null === $userMapper ? new Auth_Model_Mapper_User() : $userMapper;
    }
    ...
    public function getIdentity()
    {
        ...
        $auth->getStorage()->write(new Auth_Model_User(array(
            'role' => new Auth_Model_Role(array(
                'role_id'   => 0,
                'role'      => 'guest'    
            ))
        )));
    ...
    public function getLoginForm()
    {
        if (null === $this->_loginForm) {
            $this->_loginForm = new Auth_Form_User_Login();
        }
    ...
    public function getRegisterForm()
    {
        if (null === $this->_registerForm) {
            $this->_registerForm = new Auth_Form_User_Register();
        }
        return $this->_registerForm;
    }

    public function createUserFromForm(Auth_Form_User_Register $form)
    {
